...
class SubjectEvaluation extends Model
{
    protected $fillable = [
    ...
    {
        return $this->hasMany(SubjectEvaluationScore::class);
    }
    ...
    public function calculateTotalScore(): void
    {
        ...
        $this->max_score = $this->scores()
            ->join('rubric_criterias', 'subject_evaluation_scores.rubric_criteria_id', '=', 'rubric_criterias.id')
